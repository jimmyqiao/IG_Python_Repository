...
class IGSessionCRUD(object):
    ...
    def _get_session(self, session):
        """Returns a Requests session if session is None or session if it's not None (cached session with requests-cache for example)
...
class IGService:
    ...
    def __init__(self, username, password, api_key, acc_type, session=None):
        ...
        self.return_dataframe = False
        self.return_munch = False
